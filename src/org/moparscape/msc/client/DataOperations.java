...
public class DataOperations {
	...
	public static long getLong(byte abyte0[], int i) {
		return (((long) getInt(abyte0, i) & 0xffffffffL) << 32)
				+ ((long) getInt(abyte0, i + 4) & 0xffffffffL);
	}
	...
	public static int getSoundOffset(String arg0, byte arg1[]) {
		...
		for (int i1 = 0; i1 < i; i1++) {
			int j1 = (arg1[i1 * 10 + 2] & 0xff) * 0x1000000
					+ (arg1[i1 * 10 + 3] & 0xff) * 0x10000
					+ (arg1[i1 * 10 + 4] & 0xff) * 256
					+ (arg1[i1 * 10 + 5] & 0xff);
			int k1 = (arg1[i1 * 10 + 9] & 0xff) * 0x10000
					+ (arg1[i1 * 10 + 10] & 0xff) * 256
					+ (arg1[i1 * 10 + 11] & 0xff);
			if (j1 == j)
				return l;
			l += k1;
	...
	public static int getSoundLength(String arg0, byte arg1[]) {
		...
		for (int i1 = 0; i1 < i; i1++) {
			int j1 = (arg1[i1 * 10 + 2] & 0xff) * 0x1000000
					...
					+ (arg1[i1 * 10 + 4] & 0xff) * 256
					+ (arg1[i1 * 10 + 5] & 0xff);
			int k1 = (arg1[i1 * 10 + 6] & 0xff) * 0x10000
					+ (arg1[i1 * 10 + 7] & 0xff) * 256
					+ (arg1[i1 * 10 + 8] & 0xff);
			if (j1 == j)
				return k1;
		}
	...
	public static byte[] loadData(String arg0, int arg1, byte arg2[],
			byte arg3[]) {
